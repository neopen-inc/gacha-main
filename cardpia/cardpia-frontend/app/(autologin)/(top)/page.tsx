...
import { fetchCollectionProgress, fetchCollections } from "@cardpia-app/domain/oripa/action/collection.action";
...
import { DisplayOripa } from '@cardpia-app/components/common/oripa/display-oripa';
import './oripa.css'
import { CategoryCard } from "@cardpia-app/components/common/category";
...
export default function TopPage({}: {}) {
  ...
  return <div className="w-full mx-auto bg-white relative pb-16 text-center">
    ...
    <section className="aspect-[14/5]" style={{
      background: "url('https://storage.googleapis.com/prod-cardpia-assets/assets/topbg.png')",
