...
import { fetchCategories } from "@cardpia-app/domain/oripa/action/category.action";
import { fetchCollectionById, fetchCollectionProgress, fetchCollections } from "@cardpia-app/domain/oripa/action/collection.action";
import { CollectionProgress } from "@cardpia-app/domain/oripa/types/collection-progress";
import { useAppDispatch, useAppSelector } from "@cardpia-app/store/hooks";
import { getJSTDateString } from "@cardpia-app/util/date";
import { useRouter, useSearchParams } from "next/navigation";
import React, { useRef, useState } from "react";
import { useEffect } from "react";
import './oripa.css';
import { numberUtils, types } from "@common-utils";
import { Gacha2Button } from "@cardpia-app/components/common/button/gacha2-button";
import { createGacha } from "@cardpia-app/domain/oripa/action/gacha.action";
import { Gacha } from "@cardpia-app/domain/oripa/types/gacha";
import { fetchSceneByGrade } from "@cardpia-app/domain/oripa/action/scene.action";
import { isObject, min } from "lodash";
import { fetchUserProfile,fetchCheckinConfigs } from "@cardpia-app/domain/user";
import { Collection } from "@cardpia-app/domain/oripa/types/collection";
import { fetchCards } from "@cardpia-app/domain/oripa/action";
import { Card } from "@cardpia-app/domain/types";
import { SectionTitle } from "@cardpia-app/components/common/title/section-title";
