...
import { fetchCollectionById, fetchCollectionProgress, fetchCollections } from "@nanashinooripa-app/domain/oripa/action/collection.action";
...
import { Gacha2Button } from "@nanashinooripa-app/components/common/button/gacha2-button";
import { createGacha } from "@nanashinooripa-app/domain/oripa/action/gacha.action";
import { Gacha } from "@nanashinooripa-app/domain/oripa/types/gacha";
import { fetchSceneByGrade } from "@nanashinooripa-app/domain/oripa/action/scene.action";
import { isObject, min } from "lodash";
import { fetchUserProfile,fetchCheckinConfigs } from "@nanashinooripa-app/domain/user";
import { Collection } from "@nanashinooripa-app/domain/oripa/types/collection";
import { fetchCards } from "@nanashinooripa-app/domain/oripa/action";
import { Card } from "@nanashinooripa-app/domain/types";
    ...
    <section className="3xl:mx-20 3xl:mt-40 mt-5 md:mt-40 mb-20">
      ...
      <section className="mb-10">
        <div className="justify-center flex items-center p-4">
          <img src="/oripa/oripa-card-title.png" className="h-20" alt='oripa-title' />
      ...
      grade2Cards.length > 0 && <section className="m-10">
        <div className="justify-center flex items-center p-4">
          <img src="/oripa/oripa-card-title.png" className="h-20" alt='oripa-card-title' />
          <div className="font-semibold">
            Sランク
          </div><br />
        </div>
