...
import { PointPlanListItem } from "@nanashinooripa-app/components/point/point-plan-list-item";
import { User } from "@nanashinooripa-app/domain/user";
...
import { createCheckoutSession, fetchPointPackages, PointPackage } from "@nanashinooripa-app/domain/point";
...
export default function PointPage() {
  ...
  const pointPackages = useAppSelector(state => state.point.pointPackages);
