...
import { createCollection, fetchCollections, fetchCategories, removeCollection, updateCollection, prepareCreateCollection, prepareUpdateCollection, prepareRemoveCollection, fetchCollectionInitializeStatus, clearUpdateCollection, clearCreateCollection, clearRemoveCollection } from "@nanashinooripa-app/domain/oripa/action";
...
import { CollectionCardCount } from "@nanashinooripa-app/domain/oripa/dto";
import { Collection } from "@nanashinooripa-app/domain/types";
    ...
    <dialog.FormDialog open={updateCollectionOperation.status === 'confirm' || createCollectionOperation.status === 'confirm'}
      ...
      <div className="space-y-4">
        ...
        <Controller
          ...
          control={collectionForm.control}
          render={({ field }) => <>
          <FormControlLabel control={<Switch checked={field.value} onChange={field.onChange} size="small" />} label="一連限定" />
          <br />
          </>}
        />
        <Controller
          ...
          control={collectionForm.control}
          render={({ field }) => <>
          <FormControlLabel control={<Switch checked={field.value} onChange={field.onChange}  size="small" />} label="１日一回" />
          <br />
          </>}
        />
        <Controller
