...
import { fetchCollectionProgress, fetchCollections } from "@gacha-land-app/domain/oripa/action/collection.action";
...
import { DisplayOripa } from '@gacha-land-app/components/common/oripa/display-oripa';
import './oripa.css'
import { CategoryCard } from "@gacha-land-app/components/common/category";
...
export default function TopPage({}: {}) {
  ...
  return <div className="w-full mx-auto bg-white relative pb-16 text-center">
    ...
    <section className="justify-center text-center flex">
      <a href="https://lin.ee/bQrNNyQ"> <img src="line-banner.jpg" /> </a>
    </section>
    <div className="">
      ...
      <Swiper
          ...
          >
            ...
            pickupCollections && pickupCollections.map((collection, index) => {
              return <SwiperSlide key={collection.id} style={{
                width: '400px',
              }}><DisplayOripa oripa={collection} onClick={() => router.push(`/oripa/${collection.id}`)} collectionProgress={pickupCollectionProgressMap[collection.id]} /></SwiperSlide>
            })
            }
          </Swiper>
      </div>
