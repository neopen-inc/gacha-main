...
import { NormalLink } from "@gacha-land-app/components/common/normal-link";
import { PageTitle } from "@gacha-land-app/components/common/page-title";
import { useAppDispatch } from "@gacha-land-app/store/hooks";
import { PostUserDto, registerUser } from "@gacha-land-app/domain/user";
import _ from "lodash";
import Link from "next/link";
import { useRouter } from "next/navigation";
import { Controller, SubmitHandler, useForm } from "react-hook-form";
import { z } from "zod";
import { InputErrorMessage } from '@gacha-land-app/components/common/input-error-message';
