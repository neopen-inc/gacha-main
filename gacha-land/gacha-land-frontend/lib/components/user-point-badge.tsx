...
export function UserPointBadge({ points, onClickPoint, onClickUser }: UserPointBadgeProps) {
  ...
  <div className="relative">
    <a onClick={onClickPoint} className="items-center flex flex-row justify-end">
      <img className="lg:w-10 lg:h-10 h-10 w-10 bg-transparent z-20 translate-x-[120%] " src='/coins.png' alt={"money"} />
      <img className="lg:w-5 lg:h-5 h-5 w-5 text-red-800 translate-x-[210%] z-30" src="/plus.png" />
...
//<PlusCircleIcon className="lg:w-8 lg:h-8 h-8 w-8 text-red-800 translate-x-[120%] z-30"/>