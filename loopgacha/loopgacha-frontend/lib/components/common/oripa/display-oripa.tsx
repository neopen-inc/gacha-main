...
import { CollectionProgress } from "@loopgacha-app/domain/types";
  ...
  >
    <div>
      ...
      <div className="m-0 px-2 bg-transparent rounded-none cursor-pointer z-10 transform" >
          <div className="inset-x-0 pb-5 mt-auto bg-transparent dark:bg-white transition duration-300 ease-in-out  z-10">
            {
