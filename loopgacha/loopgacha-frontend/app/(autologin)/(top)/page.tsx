...
import { fetchCollectionProgress, fetchCollections } from "@loopgacha-app/domain/oripa/action/collection.action";
...
import { DisplayOripa } from '@loopgacha-app/components/common/oripa/display-oripa';
import './oripa.css'
import { CategoryCard } from "@loopgacha-app/components/common/category";
...
export default function TopPage({}: {}) {
  ...
  return <div className="w-full mx-auto bg-white relative pb-16 text-center">
    ...
    <section className="aspect-[14/5]" style={{
      background: "url('https://storage.googleapis.com/prod-loopgacha-assets/assets/topbg.png')",
