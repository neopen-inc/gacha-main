...
import { Collection, CollectionProgress } from "@gacha-labs-app/domain/types";
    ...
    <div>
      ...
      <div className="m-0 px-2 bg-transparent rounded-none cursor-pointer z-10 transform " style={{
        translate: '0 -15px'
          ...
          <div className="inset-x-0 h-20 mt-auto bg-transparent transition duration-300 ease-in-out  -translate-y-2 z-10">
            {
