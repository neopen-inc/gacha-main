...
import { FormLineItem } from '@gacha-labs-app/components/form/form-line-item';
import { IconBlock } from '@gacha-labs-app/components/icons/block';
import { IconDown } from '@gacha-labs-app/components/icons/down';
import { IconHeartPlus } from '@gacha-labs-app/components/icons/heart-plus';
...
import {
  ...
  prepareRemoveUsers,
  removeUsers,
} from '@gacha-labs-app/domain/user/action/user.action';
import {
  clearCreatePointTransaction,
  createPointTransaction,
  prepareCreatePointTransaction,
} from '@gacha-labs-app/domain/point/action/point-transaction.action';
...
export default function AdminUserPage() {
  ...
  const [deactiveDialog, setDeactiveDialog] = React.useState(false);
