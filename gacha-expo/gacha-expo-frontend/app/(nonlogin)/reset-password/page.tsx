...
import { resetPassword, sendResetPasswordEmail } from "@gacha-expo-app/domain/user";
...
export default function ResetPasswordPage({
  ...
  return searchParams.token ? <div className="flex flex-col items-center justify-center min-h-screen p-5 bg-white min-w-screen">
    ...
    <div className="max-w-xl p-8 text-center text-gray-800 bg-white lg:max-w-3xl rounded-3xl lg:p-12">
      ...
      <TextField variant="outlined" size="small" placeholder="パスワード" type="password" name="password" onChange={(event) => setPassword(event.target.value)} />
      <div className="mt-4">
        <PrimaryButton 
    ...
    <div className="max-w-xl p-8 text-center text-gray-800 bg-white lg:max-w-3xl rounded-3xl lg:p-12">
      ...
      <TextField value={email} variant="outlined" size="small" placeholder="メールアドレス" onChange={onInputEmail} />
      <div className="mt-4">
