...
export class CollectionCourseController {
  constructor(private readonly collectionCourseService: CollectionCourseService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateCollectionCourseDto: UpdateCollectionCourseDto) {
