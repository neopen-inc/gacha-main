...
import { PointPlanListItem } from "@toreca-jp-app/components/point/point-plan-list-item";
import { PointPackage, fetchPointPackages, createCheckoutSession} from "@toreca-jp-app/domain/point";
import { User } from "@toreca-jp-app/domain/user";
  ...
  return <div className="flex justify-center w-full">
    <section className="p-5 max-w-2xl w-[80%] flex flex-row flex-wrap">
      <header className="rounded-t-md text-white bg-foregroundOrange flex flex-row w-full justify-left items-center px-5 py-1">
        <img src="/money-icon-white.png" className="w-5 h-5" alt={'icon'} />
        <span>トリコイン購入</span>
      </header>
      <div className="bg-white p-4 w-full " style={{
        boxShadow: '0 0 10px 0 rgba(0,0,0,0.1)'
      }}>
        <span className="text-gray-500 text-sm text-left">ご希望のポイントをお選びください</span>
