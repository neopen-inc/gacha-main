        ...
        <div className="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0">
          <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
            ...
            <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
              <button onClick={onConfirm} type="button" className={`inline-flex w-full justify-center rounded-md ${color === 'primary' ? 'bg-primary' : color === 'red' ? 'bg-red-800' : 'bg-gray-800'} px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-${color}-500 sm:ml-3 sm:w-auto`}>{confirmLabel}</button>
