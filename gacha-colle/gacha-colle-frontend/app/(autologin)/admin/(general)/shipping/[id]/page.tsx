...
import { updateShipping } from "@gacha-colle-app/domain/shipping/action";
import { clearUpdateShipping, fetchShippingById, prepareUpdateShipping } from "@gacha-colle-app/domain/shipping/action/shipping.action";
          ...
          <ul role="list" className="divide-y divide-gray-100 rounded-md border border-gray-200">
            ...
            fetchShippingByIdOperation.payload?.lineItems.map((lineItem, index) => 
              ...
              lineItem?.card ? 
                ...
                : <div className="flex flex-col w-0 flex-1">カードが削除されました</div>
              }
            </li>)
            }
          </ul>
