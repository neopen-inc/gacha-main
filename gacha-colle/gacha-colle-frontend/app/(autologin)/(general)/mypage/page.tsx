...
import { Hr } from "@gacha-colle-app/components/common/hr";
...
import { fetchUserAddresses, logout } from "@gacha-colle-app/domain/user";
    ...
    <div className="pb-20 ">
      <div className="p-4">
        ...
        <div className="flex justify-between">
          <PrimaryButton size="medium" onClick={() => router.push('/point')}>ポイントを購入</PrimaryButton>
        </div>
      </div>
