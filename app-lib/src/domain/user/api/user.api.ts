import { LoginResponse, PostCheckTokenDto, PostLoginDto } from '@gacha-colle-app/domain/user/dto/login.dto';
import { axiosInstance } from '@gacha-colle-app/util/axios';
import { AxiosResponse } from 'axios';
import { User } from '../types';
import { GetUserListOptions, PostUserDto, UpdateUserDto } from '../dto';
