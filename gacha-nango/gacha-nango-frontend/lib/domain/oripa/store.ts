...
export const oripaSlice = createSlice({
  ...
  }).addCase(prepareCreateScene.fulfilled, (state, { payload }) => {
    state.operations.createScene = {
      status: 'confirm',
    }
