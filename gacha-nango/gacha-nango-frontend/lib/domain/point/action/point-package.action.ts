...
export const clearCreatePointPackage = createAsyncThunk<void, void>('point/clear-create-point-package', async () => {
  return;
});
...
export const clearUpdatePointPackage = createAsyncThunk<void, void>('point/clear-update-point-package', async () => {
  return;
});
...
export const clearRemovePointPackage = createAsyncThunk<void, void>('point/clear-remove-point-package', async () => {
  return;
});