...
import { CollectionCardCount } from "@gacha-nango-app/domain/oripa/dto";
import { Collection } from "@gacha-nango-app/domain/types";
    ...
    <dialog.FormDialog open={updateCollectionOperation.status === 'confirm' || createCollectionOperation.status === 'confirm'}
      ...
      <div className="space-y-4">
        ...
        <Controller
          ...
          control={collectionForm.control}
          render={({ field }) => <>
          <FormControlLabel control={<Switch checked={field.value} onChange={field.onChange} size="small" />} label="一回限定" />
          <br />
          </>}
        />
        <Controller
