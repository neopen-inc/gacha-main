...
import { fetchUserAddresses, fetchUserProfile } from "@gacha-nango-app/domain/user";
import { Button, MenuItem, Select, Typography } from "@mui/material";
import _ from "lodash";
import { useRouter } from "next/navigation";
import React, { useEffect } from "react";
import { clearReturnItem, prepareReturnItem, returnMany } from "@gacha-nango-app/domain/oripa/action";
import { clearCreateShipping, createShipping, prepareCreateShipping } from "@gacha-nango-app/domain/shipping";
...
export default function ResultPage() {
  ...
  return <div className=" w-screen lg:w-[80%] m-auto flex flex-col">
    ...
    <footer className="w-full h-30 border-t-2 border-[#AAA] pt-10">
