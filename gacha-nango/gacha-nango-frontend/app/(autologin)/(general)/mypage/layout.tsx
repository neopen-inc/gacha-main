...
import { OutlinedButton } from "@gacha-nango-app/components/common/link/outlined-button";
...
import { fetchUserProfile, setAuthInfo } from "@gacha-nango-app/domain/user";
import React from "react";
import { numberUtils } from "@common-utils";
import { MypageSidebar } from "@gacha-nango-app/components/mypage/mypage-sidebar";
  ...
  return <div className="flex min-h-screen ">
    ...
    <div className="grow bg-[#f3f3f3] lg:p-10">
      <div className="justify-center flex">
        <img src="/ad.png" className="w-4/5" />
      </div>
      {children}
    </div>
  </div>
